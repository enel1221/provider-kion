...
PROJECT_NAME ?= provider-kion
PROJECT_REPO ?= github.com/enel1221/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 0.3.34
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-kion
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= ${TERRAFORM_PROVIDER_REPO}/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-kion_v0.3.34
...
xpkg.build.provider-kion: do.build.images
