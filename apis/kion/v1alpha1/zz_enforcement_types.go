...
type EnforcementInitParameters struct {
...
// EnforcementSpec defines the desired state of Enforcement
type EnforcementSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     EnforcementParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider EnforcementInitParameters `json:"initProvider,omitempty"`
}

// EnforcementStatus defines the observed state of Enforcement.
type EnforcementStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EnforcementObservation `json:"atProvider,omitempty"`
}
...
// Enforcement is the Schema for the Enforcements API. <no value>
...
type Enforcement struct {
	...
	Spec   EnforcementSpec   `json:"spec"`
	Status EnforcementStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// EnforcementList contains a list of Enforcements
type EnforcementList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Enforcement `json:"items"`
}

// Repository type metadata.
var (
	Enforcement_Kind             = "Enforcement"
	Enforcement_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Enforcement_Kind}.String()
	Enforcement_KindAPIVersion   = Enforcement_Kind + "." + CRDGroupVersion.String()
	Enforcement_GroupVersionKind = CRDGroupVersion.WithKind(Enforcement_Kind)
)

func init() {
	SchemeBuilder.Register(&Enforcement{}, &EnforcementList{})
}
