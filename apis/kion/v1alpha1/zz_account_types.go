...
type AccountInitParameters_3 struct {
	...
	MoveProjectSettings []AccountMoveProjectSettingsInitParameters_2 `json:"moveProjectSettings,omitempty" tf:"move_project_settings,omitempty"`
...
type AccountMoveProjectSettingsInitParameters_2 struct {
...
type AccountMoveProjectSettingsObservation_2 struct {
...
type AccountMoveProjectSettingsParameters_2 struct {
...
type AccountObservation_3 struct {
	...
	// (Block Set, Max: 1) Parameters used when moving an account between Kion projects.  These settings are ignored unless moving an account. (see below for nested schema)
	// Parameters used when moving an account between Kion projects.  These settings are ignored unless moving an account.
	MoveProjectSettings []AccountMoveProjectSettingsObservation_2 `json:"moveProjectSettings,omitempty" tf:"move_project_settings,omitempty"`
...
type AccountParameters_3 struct {
	...
	// Parameters used when moving an account between Kion projects.  These settings are ignored unless moving an account.
	// +kubebuilder:validation:Optional
	MoveProjectSettings []AccountMoveProjectSettingsParameters_2 `json:"moveProjectSettings,omitempty" tf:"move_project_settings,omitempty"`
...
type AccountSpec struct {
	...
	ForProvider     AccountParameters_3 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AccountInitParameters_3 `json:"initProvider,omitempty"`
}

// AccountStatus defines the observed state of Account.
type AccountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AccountObservation_3 `json:"atProvider,omitempty"`
}
